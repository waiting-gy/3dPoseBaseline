...
class Linear(nn.Module):
    def __init__(self, linear_size, p_dropout=0.5):
        ...
        ######################################################################
        self.dilat2 = nn.Conv1d(in_channels=1, out_channels=1, kernel_size=4, dilation=2, bias=False, padding=3)
        ######################################################################
        self.batch_norm1 = nn.BatchNorm1d(self.l_size)

        self.w2 = nn.Linear(self.l_size, self.l_size)
        ######################################################################
        self.dilat3 = nn.Conv1d(in_channels=1, out_channels=1, kernel_size=4, dilation=2, bias=False, padding=3)
        ######################################################################
...
class LinearModel(nn.Module):
    def __init__(self,
        ...
        #kernel_size   : 2 3 4
        #padding       : 1 2 3
        self.dilat1 = nn.Conv1d(in_channels=1, out_channels=1,kernel_size=4, dilation=2, bias=False, padding=3)
        self.dilat2 = nn.Conv1d(in_channels=1, out_channels=1, kernel_size=4, dilation=2, bias=False, padding=3)
        self.dilat3 = nn.Conv1d(in_channels=1, out_channels=1, kernel_size=4, dilation=2, bias=False, padding=3)
        self.dilat4 = nn.Conv1d(in_channels=1, out_channels=1, kernel_size=4, dilation=2, bias=False, padding=3)
